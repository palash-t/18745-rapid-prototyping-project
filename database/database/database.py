...
def insert_biometric(db, patient_id, heart_rate, sbp, dbp):
    ...
    query = '''
         INSERT INTO biometric (patient_id, heart_rate, sbp, dbp)
           VALUES (%s, %s, %s, %s);
    '''
    data = (patient_id, heart_rate, sbp, dbp)
...
def insert_many_biometrics(db, rows):
    ...
    query = '''
         INSERT INTO biometric (patient_id, heart_rate, sbp, dbp)
           VALUES (%(patient_id)s, %(heart_rate)s, %(sbp)s, %(dbp)s);
    '''
